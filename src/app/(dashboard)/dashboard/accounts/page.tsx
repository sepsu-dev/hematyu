...
export default function AccountsPage() {
  const accounts = [
    { name: "Dompet Utama", type: "Cash", balance: "Rp 14,250,000", color: "from-blue-500 to-indigo-600", no: "Cash Wallet" },
    { name: "Bank BCA", type: "Bank Account", balance: "Rp 8,450,000", color: "from-sky-500 to-blue-600", no: "xxxx-8920" },
    { name: "Bank Mandiri", type: "Bank Account", balance: "Rp 5,800,000", color: "from-emerald-500 to-teal-600", no: "xxxx-4412" },
  ];
    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {accounts.map((acc, idx) => (
          <div key={idx} className="bg-white border border-stone-200 rounded-lg p-6 shadow-sm flex flex-col justify-between h-40 hover:border-primary/20 transition-all">
            <div className="flex items-center justify-between">
              <div>
              ...
              <div className={`w-8 h-8 rounded-lg bg-gradient-to-br ${acc.color} flex items-center justify-center text-white`}>
