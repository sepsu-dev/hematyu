    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="border border-[#E7DED4] shadow-lg rounded-2xl bg-white">
        <CardHeader className="text-center pb-4 pt-6 sm:pt-8 px-6 sm:px-8">
          <CardTitle className="text-xl font-black text-stone-900 tracking-tight">Selamat Datang</CardTitle>
          <CardDescription className="text-xs text-stone-500 font-semibold mt-1">
            Masuk dengan Google atau masukkan akun hemat.yu Anda
          </CardDescription>
        </CardHeader>
            ...
            <FieldGroup>
              ...
              <Field className="grid gap-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-xs font-bold text-stone-500 hover:text-stone-900 underline-offset-4 hover:underline"
                  >
                    Lupa sandi?
                  </Link>
                </div>
                <div className="relative">
                  <Input
                    ...
                    placeholder="••••••••"
                    className="bg-[#FAF6F0] border-[#E7DED4] text-xs font-semibold focus-visible:ring-stone-400 pr-10"
                    required
                  />
                  <button
                    type="button"
              ...
              <Field className="grid gap-4 mt-2">
                <label className="flex items-center gap-2 text-[11px] font-bold text-stone-500 cursor-pointer select-none">
                  <input type="checkbox" name="remember" className="accent-stone-800 rounded" />
                  Ingat saya
                </label>
